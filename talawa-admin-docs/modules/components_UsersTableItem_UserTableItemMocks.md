...
[src/components/UsersTableItem/UserTableItemMocks.ts:7](https://github.com/takshakmudgal/talawa-admin/blob/822fbcb/src/components/UsersTableItem/UserTableItemMocks.ts#L7)
